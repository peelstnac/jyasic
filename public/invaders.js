...
var playerOn = []; //list of newly connected player IDs
var playerOff = []; //list of newly disconnected player IDs
var bullets = [];
var enemyBullets = [];
var explosions = [];
var enemies = [];
...
var playerMap = {}; //id: player object

//socket should update 15 FPS
socket.on('state', (data) => {
    data.playerOn = playerOn;
    data.playerOff = playerOff;
    //handle player connections here
    ...
    //other variables handled outside
    data.bullets = bullets;
    data.enemyBullets = enemyBullets;
    data.explosions = [];
    data.enemies = [];
    data.powerups = [];
});

//client game loop at 30 FPS
setInterval(() => {
